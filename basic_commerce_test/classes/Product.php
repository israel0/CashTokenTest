...
include_once($filepath.'/../classes/Interface/ProductInterface.php');
include_once($filepath.'/../classes/ProductDiscount.php');
...
class Product extends ProductDiscount  implements  ProductInterface
{
    private $db;
    private $fm;
    ...
    public function productInsert($data, $file)
    {
        ...
        //  Define Specialized Discount By User Type

        $discountStrategy = new ProductDiscount($brandId, $price);
        $discount    =  $discountStrategy->getDiscount();
        ...
        if (empty($file_name)) {
            ...
            $query = "INSERT INTO tbl_product(productName, catId, brandId, body, price, image, type, discount) VALUES('$productName', '$catId', '$brandId', '$body', '$price', '$uploaded_image', '$type', '$discount')";
