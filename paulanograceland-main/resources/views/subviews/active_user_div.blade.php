    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        <li class="<?php echo ($activeMenu == 2) ? 'active' : ''; ?> dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li class="divider"></li>
                <li><a href="<?php echo url("terms") ?>">Terms and Conditions</a></li>
            </ul>
        </li>
        <li class="<?php echo ($activeMenu == 3) ? 'active' : ''; ?>"><a href="<?php echo url("compensation_plan") ?>">COMPENSATION PLAN</a></li>
