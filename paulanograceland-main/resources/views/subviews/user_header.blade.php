    ...
    <div id="main-navbar" class="navbar navbar-default">
        <div class="">
            <div class="navbar-header">
                <a class="title navbar-brand" href="<?php echo url("") ?>"><?php echo $title ?></a>
                ...
                <ul class="nav navbar-nav navbar-right hidden-xs">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo url("myaccount"); ?>">Account Settings</a></li>
                            <li class="divider"></li>
                            <li><a href="<?php echo url("myaccount/change_password"); ?>">Change Password</a></li>
                            <li class="divider"></li>
                            <li><a href="<?php echo url("myaccount/change_picture"); ?>">Change Profile Picture</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a href="<?php echo url("user/messages"); ?>"><span class="fa fa-envelope"></span> <sup class="notification badge <?php echo ($message_count == 0) ? "hidden" : "" ?>"><?php echo $message_count ?></sup></a></li>
